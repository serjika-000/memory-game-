        ...
        <main className="bg-darkBlack h-screen font-athl text-white flex flex-col justify-center items-center text-center">
            ...
            <section className="bg-white3 mt-6 py-6 px-4 sm:w-3/4 max-w-96 rounded-xl flex flex-col " aria-label="This section has the settings for the game.">
               ...
               <div className="flex justify-between mb-4" aria-label="Options to select the theme of the game.">
                    <button className={`${theme === 'numbers' ? 'bg-darkGray' : 'bg-lightGray'} ${theme === 'numbers' ? '' : 'hover:bg-lightBlue2'} w-full mr-1 sm:mr-3 px-6 py-2  rounded-3xl`} onClick={() => setTheme('numbers')}>Numbers</button>
               ...
               <div className="flex justify-between sm:justify-center mb-4" aria-label="Options to select number of players in the game.">
                    <button className={`${players === 1 ? 'bg-darkGray' : 'bg-lightGray'} ${players === 1 ? '' : 'hover:bg-lightBlue2'} w-full mr-1 sm:mr-3 px-6 py-2 rounded-3xl`} onClick={() => setPlayers(1)}>1</button>
                    <button className={`${players === 2 ? 'bg-darkGray' : 'bg-lightGray'} ${players === 2 ? '' : 'hover:bg-lightBlue2'} w-full mr-1 sm:mr-3 px-6 py-2 rounded-3xl`} onClick={() => setPlayers(2)}>2</button>
                    <button className={`${players === 3 ? 'bg-darkGray' : 'bg-lightGray'} ${players === 3 ? '' : 'hover:bg-lightBlue2'} w-full mr-1 sm:mr-3 px-6 py-2 rounded-3xl`} onClick={() => setPlayers(3)}>3</button>
                    <button className={`${players === 4 ? 'bg-darkGray' : 'bg-lightGray'} ${players === 4 ? '' : 'hover:bg-lightBlue2'} w-full  sm:mr-3 px-6 py-2 rounded-3xl`} onClick={() => setPlayers(4)}>4</button>
               </div>
               ...
               <div className="flex justify-between mb-4" aria-label="Options to select the grid size of the game.">
                    <button className={`${gridSize === '4x4' ? 'bg-darkGray' : 'bg-lightGray'} ${gridSize === '4x4' ? '' : 'hover:bg-lightBlue2'} w-full mr-1 sm:mr-3 px-6 py-2 rounded-3xl`} onClick={() => setGridSize('4x4')}>4x4</button>
